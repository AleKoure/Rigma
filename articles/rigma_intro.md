...
An account in Figma can be accessed using the API and a personal access
token.
...
Various POST and GET methods are provided in this package to interact
with a Figma files and teams.
